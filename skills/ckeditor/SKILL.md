...
description: >-
  ...
  CDN, ZIP), editor type, features and toolbar, CSS, license keys, premium
  features, and setup errors. NOT for authoring custom plugins, upgrading
  versions, or CKEditor 4.
license: MIT
allowed-tools:
  - Read
  - Write
